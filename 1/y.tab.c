  ...
  switch (yyn)
    {
        case 2:
#line 16 "1b.y"
    {(yyval)=(yyvsp[(1) - (1)]);yylval=(yyval);}
    break;

  case 3:
#line 17 "1b.y"
    {(yyval)=(yyvsp[(1) - (3)])+(yyvsp[(3) - (3)]);yylval=(yyval);}
    break;
...
else (yyval)=(yyvsp[(1) - (3)])/(yyvsp[(3) - (3)]);yylval=(yyval);}
    break;
